...
PAGES = ['README', 'getting-started', 'rajerwei', 'ju-guai', 'combat', 'food', 'moves', 'online']
LABELS = ['百科首页', '新手入门', 'RajerWei', 'JU GUAI', '战斗系统', '食物与召唤', '完整招式数据', '联机与问题']
...
<div class="layout"><aside><p class="eyebrow">办公室生存手册</p><nav aria-label="百科栏目">{nav}</nav><p class="sidebar-note">2 位角色 · 8 个技能<br>今天的班，就上到这里。</p></aside>
